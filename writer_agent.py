...
class BedTimestory(BaseModel):
    ...
    story: str = Field(description="The full text of the bedtime story.")
    reading_time_in_minutes: int = Field(
        description="Estimated reading time in minutes."
    )
    fun_fact_included: str | None = Field(
        description="An educational fun fact included in the story if requested."
    )
...
INSTRUCTIONS = """
You are a beloved children's bedtime story author. 
Your stories help children drift off to sleep feeling safe, happy, and loved. 
You will write a complete bedtime story based on detailed parameters provided 
by the user and inspirations from web research made by another agent.
...
- Story Language - the language to write the story in (German, English or Arabic)

Deep instrcutions:
1. LANGUAGE: Write in the language specified (German, English, or Arabic). 
